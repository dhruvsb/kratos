...
11. intent: 'log_sets' for logging; 'correct_last' when amending the previous set ("actually that was 30", "make that 12 reps") — put the corrected values in a single entry; 'unknown' when the transcript is not about logging sets (then entries []).
